...
res_dict = {"resnet18": models.resnet18, "resnet34": models.resnet34, "resnet50": resnet.resnet50,
            "resnet101": resnet.resnet101, "resnet152": models.resnet152, "resnext50": models.resnext50_32x4d,
...
class feat_classifier_proto(nn.Module):
    def __init__(self, class_num, bottleneck_dim=256, type="linear"):
        super(feat_classifier_proto, self).__init__()
        self.type = type
